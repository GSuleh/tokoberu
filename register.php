...
if ( $result->num_rows > 0 ) {
    ...
    $sql = "INSERT INTO user (first_name, last_name, email, password, active) " 
            . "VALUES ('$first_name','$last_name','$email','$password','$act')";
    ...
    if ( $mysqli->query($sql) ){
        ...
        $to      = $email;
        $subject = 'Activating account ( clevertechie.com )';
       $message_body = '
        Hello '.$first_name.',
